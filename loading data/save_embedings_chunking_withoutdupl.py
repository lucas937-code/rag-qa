...
# Chunking parameters
CHUNK_SIZE = 1000  # number of tokens/words per chunk
CHUNK_OVERLAP = 250  # number of tokens/words to overlap
...
def main():
    if os.path.exists(EMBEDDINGS_FILE):
        ...
        # REMOVE DUPLICATE PASSAGES BEFORE EMBEDDING
        before = len(corpus)
        corpus = list(dict.fromkeys(corpus))  # fast, preserves order
        after = len(corpus)
